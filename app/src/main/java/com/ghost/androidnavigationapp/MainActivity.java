package com.ghost.androidnavigationapp;
...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_Mpesa) {
            ...
            Toast.makeText(this, "Dial clicked", Toast.LENGTH_SHORT).show();

        } else if (id == R.id.nav_Call) {

            Toast.makeText(this, " Call cliked", Toast.LENGTH_SHORT).show();
